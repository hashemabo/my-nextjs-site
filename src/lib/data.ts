...
export const products: Product[] = [
  {
    ...
    images: [findImage('product-2'), findImage('gallery-1'), findImage('gallery-3')],
  ...
  },
  {
    ...
    images: [findImage('product-1'), findImage('gallery-1'), findImage('gallery-3')],
  ...
  },
  {
    ...
    images: [findImage('product-3'), findImage('gallery-5'), findImage('gallery-6')],
  ...
  },
  {
    ...
    images: [findImage('product-5'), findImage('gallery-2'), findImage('gallery-4')],
  ...
  },
  {
    ...
    images: [findImage('product-6'), findImage('gallery-5'), findImage('gallery-6')],
  ...
  },
   {
    ...
    images: [findImage('product-7'), findImage('gallery-1'), findImage('gallery-2')],
    prices: { sar: 125, aed: 135, kwd: 11 },
  },
  {
    id: 'prod-008',
    ...
    images: [findImage('product-8'), findImage('gallery-3'), findImage('gallery-4')],
    prices: { sar: 125, aed: 135, kwd: 11 },
  },
];
